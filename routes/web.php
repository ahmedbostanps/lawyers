...
//---------------------------Client-----------------------//
    ...
    Route::post('contracts/data-list', 'ContractController@ContractList')->name('contracts.list');
    Route::get('contracts/{id}/print', 'ContractController@print')->name('contracts.print');
    Route::get('contract/get_terms/{id?}', 'ContractController@getTermsByCategory')->name('contracts.get.terms.by.category');
    Route::post('contract/data-status', 'ContractController@changeStatus')->name('contracts.status');


    Route::resource('contracts_categories', 'ContractCategoryController');
    Route::post('contracts/categories/data-list', 'ContractCategoryController@ContractCaegoryList')->name('contract.categories.list');

    Route::resource('contracts_terms', 'ContractTermsController');
    Route::post('contracts/terms/data-list', 'ContractTermsController@ContractTermList')->name('contract.terms.list');
...
//---------------------setting court type--------------------------//
    ...
    Route::get('client_user/{id}/tasks', 'ClientUserController@tasks')->name('client_user.tasks');
    Route::post('client_user/{id}/tasks/datatable', 'ClientUserController@tasksDatatable')->name('client_user.tasks.data');
