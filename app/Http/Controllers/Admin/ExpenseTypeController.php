...
class ExpenseTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'تمت إضافة نوع النفقات بنجاح',
    ...
    public function update(Request $request, $id)
    {
        ...
        $casetype->save();
           ...
           return response()->json([
            'success' => true,
            'message' => 'تم تحديث نوع النفقات بنجاح',
     ...
     */
       ...
       $data->is_active  = $request->status == 'true' ? 'Yes' : 'No' ;
        ...
        $message = 'تم تغيير حالة نوع النفقات بنجاح.' ;
   ...
   public function destroy($id)
    {
        ...
        return response()->json([
                       'success' => true ,
                       'message' => 'تم حذف نوع النفقات بنجاح.'
                       ],200);
                  ...
                  return response()->json([
                       'error' => true ,
                       'errormessage' => 'لا يمكنك حذف نوع النفقات لأنه مستخدم في وحدة أخرى.'
                       ],400);
        }
    }
}
