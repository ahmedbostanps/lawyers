...
var FormControlsClient = {
    ...
    init: function () {
        ...
        $("#add_expense").validate({
            ...
            messages: {
                vendor_id: "الرجاء تحديد البائع.",
                inv_no: "رقم الفاتورة مطلوبة",
                due_Date: "الرجاء تحديد التاريخ.",
                inv_date: "الرجاء تحديد التاريخ.",
...
function getVendorBillingAddress(id) {
    ...
    if (id != '') {
        ajaxindicatorstart('فضلا انتظر لحظة..');
        $('.show_vendor_detail').html('تفاصيل التحميل ...');
        $.ajaxSetup({
            headers: {
