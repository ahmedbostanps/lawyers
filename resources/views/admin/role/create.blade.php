    ...
    <div class="modal-dialog" role="document">
        <form action="{{ route('role.store') }}" method="POST" id="roleForm" name="roleForm" >
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">{{ __('panel.add_Role') }}</h4>
            </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_subtype">{{ __('panel.Role Name') }} <span class="text-danger">*</span></label>
              <input type="text" placeholder="" class="form-control" id="slug" name="slug">
          </div>
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_subtype">{{ __('panel.Role Description') }}</label>
