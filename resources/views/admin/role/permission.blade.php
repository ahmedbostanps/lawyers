                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <table class="table">
                        <thead>
                          <tr>
                            <th width="30%">القائمة</th>
                            <th width="30%">القائمة الفرعية</th>

                            <th width="10%"><input class="all_view" type="checkbox">&nbsp; عرض </th>
                            <th width="10%"> <input class="all_add" type="checkbox">&nbsp; إضافة</th>
                            <th width="10%"> <input class="all_edit" type="checkbox">&nbsp;تعديل</th>
                            <th width="10%"> <input class="all_delete" type="checkbox">&nbsp;حذف</th>
                          </tr>
                        </thead>
                        <tbody>
                   ...
                   <div class="form-group pull-right">
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <a href="{{ route('role.index')  }}" class="btn btn-danger">{{__('constants.cancel')}}</a>

                          <button type="submit" class="btn btn-success"><i class="fa fa-save" id="show_loader"></i>&nbsp;{{__('constants.save')}}</button>
                        </div>
                  </div>
                </form>
              </div>
