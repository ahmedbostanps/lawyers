...
<head>
    ...
    <link href="{{asset('assets/admin/vendors/bootstrap/dist/css/bootstrap-rtl.css') }}" rel="stylesheet">
    <link href="{{asset('assets/admin/vendors/bootstrap-rtl-master/dist/css/bootstrap-rtl.min.css') }}"
          rel="stylesheet">
    ...
    <link href="{{asset('assets/admin/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') }}"
          rel="stylesheet"/>
    <!-- Custom Theme Style -->
    <link href="{{asset('assets/admin/build/css/customrtl.css') }}" rel="stylesheet">
            ...
            <div class="left_col scroll-view">
                <div class="navbar nav_title app-border">
                    <a href="{{url('')}}" class="site_title">
                        ...
                        <span>نظام المحامين</span>
                        {{--                        <span>{{ $image_logo->company_name ?? '' }}</span>--}}
                    </a>
                </div>
