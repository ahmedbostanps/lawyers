                                    ...
                                    @foreach($tasks as $task)
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="discount_text "> <b
                                                                class="position_name">المستخدمون</b><span
                                                                class="text-danger">*</span></label>
                                                        <select multiple class="form-control" name="assigned_to">
                                                            @foreach($users as $key=>$val)
                                                                <option {{ in_array($val->id , $task->members->pluck('employee_id')->toArray() ) ? 'selected' : '' }}
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="fullname">العنوان <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" placeholder="" class="form-control"
                                                               id="task_subject" value="{{ $task->task_subject }}"
                                                               name="task_subject">
                                                    </div>
                                                </div>

                                                <div class="col-md-3 form-group">
                                                    <label for="fullname">تاريخ البدء <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" placeholder="" class="form-control"
                                                           id="start_date" value="{{ $task->start_date }}"
                                                           name="start_date">
                                                    {{--                                readonly=""--}}
                                                </div>

                                                <div class="col-md-3 col-xs-12 form-group">
                                                    <label for="fullname">الموعد الأخير<span
                                                            class="text-danger">*</span></label>
