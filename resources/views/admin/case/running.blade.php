                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                ...
                                <li role="presentation" class="{{(Request::is('admin/case-running'))?'active':''}} ">
                                    <a href="{{url('admin/case-running')}}">القضايا الفعالة</a>
                                </li>
                        ...
                        <table id="case_list" class="table">
                            ...
                            <tr>
                                <th width=" 3%">No</th>
                                <th width="20%">العميل وتفاصيل القضية</th>
                                <th width="35%">تفاصيل المحكمة</th>
                                <th width="20%">الملتمس مقابل المدعى عليه</th>
                                <th width="10%">التاريخ القادم</th>
                                <th width="9%">الحالة</th>
                                <th width="3%">الإجراء</th>
                            </tr>
                            </thead>
