        ...
        <form action="{{ route('tax.store') }}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">{{ __('panel.create_tax') }}</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_type">{{ __('constants.name') }} <span class="text-danger">*</span> </label>
                            <input type="text" placeholder="" class="form-control" id="name" name="name" value="">
                        </div>

                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">{{ __('panel.tax_rate') }}(%) <span class="text-danger">*</span></label>
                            <input type="text" placeholder="" class="form-control" id="per" name="per">
                        </div>

                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">{{ __('constants.note') }} </label>
