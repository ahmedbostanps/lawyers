        ...
        <form action="{{ route('case-type.store') }}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">{{ __('panel.create_case_type') }}</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_type">{{ __('panel.case_type') }} </label>
                            <select class="form-control case_type" id="case_type" name="case_type">
                                <option value="">{{ __('panel.select_case_type') }}</option>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">{{ __('panel.case_sub_type') }} <span class="text-danger">*</span></label>
