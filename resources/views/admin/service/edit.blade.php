    ...
    <div class="modal-dialog" role="document">
        <form action="{{route('service.update',$service->id)}}" method="POST" id="tagForm" name="tagForm" >
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">تحرير الخدمة</h4>
            </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_subtype">{{ __('constants.name') }} <span class="text-danger">*</span></label>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_subtype">{{ __('constants.amount') }} <span class="text-danger">*</span></label>
