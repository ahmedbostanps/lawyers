        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    ...
                    <a href="{{ url('admin/expense') }}" class="btn btn-primary">{{ __('constants.back') }}</a>
                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <label for="vendor">البائع <span class="text-danger">*</span></label>
                                    <select class="form-control select2" name="vendor_id" id="vendor_id"
                                        ...
                                        <option value="">حدد البائع</option>
                                    ...
                                    <label for="billed_from">وصفت من <span class="text-danger">*</span></label><br>
                        ...
                        <div class="col-sm-4 form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-5 col-sm-3 col-xs-12">رقم الفاتورة <span
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-5 col-sm-3 col-xs-12">تاريخ الفاتورة: <span
                                            class="text-danger">*</span></label>
                                <div class="col-md-7 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-5 col-sm-3 col-xs-12">تاريخ استحقاق الفاتورة: <span
                                            class="text-danger">*</span></label>
                                <div class="col-md-7 col-sm-9 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="group">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th width="" class="text-center">وصف
                                        ...
                                        <th class="hide with_tax" width="15%" class="text-center">{{ __('panel.tax') }} (%)</th>
                                        <th class="hide with_tax" width="10%" class="text-center">{{ __('panel.tax') }} (₹)</th>
                                        <th width="10%" class="text-center">{{ __('constants.amount') }}</th>
                                        <th width="5%" class="text-center">{{ __('panel.Action') }}</th>
                                    </tr>
                                    </thead>
                            ...
                            <button data-repeater-create type="button" value="Add New"
                                ...
                                <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;أضف المزيد
                            </button>

                            <div class="row">
                                <div class="col-sm-3">
                                    <div>
                                        <p class="text-danger">* الحقول الإلزامية</p>
                                        <ul/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-7 col-md-7">
                                    <div class="contct-info">
                                        <div class="form-group">
                                            <label class="discount_text"> {{ __('constants.note') }}
                                            </label>
                                ...
                                <div class="pull-right col-md-5">
                                    <table class="table row-border dataTable no-footer" id="tab_logic_total">
                                        <tr>
                                            <th class="text-left expence-p-top-18">المجموع الفرعي</th>
                                        ...
                                        <tr>
                                            <th class="text-center">
                                                <select id="tax" class="tax" name="tax" class="form-control">
                                                    <option MyTax="" value="">حدد الضرائب</option>
                                                    @foreach($tax as $t)
                                    ...
                                    <table class="table row-border dataTable no-footer" id="tab_logic_total">
                                        ...
                                        <tr>
                                            <th class="text-left expence-p-top-18">المجموع</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ url('admin/expense') }}" class="btn btn-danger"> {{ __('constants.cancel') }}</a>

                                    <button type="submit" name="btn_add_offer" class="btn_add_offer btn btn-success"><i
                                                class="fa fa-save" id="show_loader"></i>&nbsp; {{ __('constants.save') }}
                                    </button>
