                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <label for="billed_from">وصفت من </label><br>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ url('admin/invoice') }}" class="btn btn-danger"> {{ __('constants.cancel') }}</a>

                                    <button type="submit" name="btn_add_offer" class="btn_add_offer btn btn-success"><i
                                            class="fa fa-save" id="show_loader"></i>&nbsp;{{ __('panel.save') }}
                                    </button>
