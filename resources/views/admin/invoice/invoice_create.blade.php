        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    ...
                    <a href="{{ url('admin/invoice') }}" class="btn btn-primary">{{ __('constants.back') }}</a>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group ">
                                    <label for="vendor">عميل <span class="text-danger">*</span></label>
                            ...
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th class="hide with_tax" width="15%" class="text-center">ضريبة (%)</th>
                                        <th class="hide with_tax" width="10%" class="text-center">ضريبة (₹)</th>
                                        <th width="10%" class="text-center">مقدار</th>
                                        <th width="5%" class="text-center">{{ __('constants.actions') }}</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr data-repeater-item>
                                        ...
                                        <th width="30%" class="text-center">
                                            <select class="form-control sel services" name="services" id="services"
                                                ...
                                                <option MyServiceAmount="0.00" value="">حدد الخدمات</option>
