                            ...
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th class="hide with_tax" width="15%" class="text-center">الضريبة (%)</th>
                                        <th class="hide with_tax" width="10%" class="text-center">الضريبة </th>
                                        <th width="10%" class="text-center">المبلغ</th>
                                        <th width="5%" class="text-center">العمليات</th>
                                    </tr>
                                    </thead>
                                        ...
                                        <tr data-repeater-item>
                                            ...
                                            <th width="30%" class="text-center">
                                                <select class="form-control sel services" name="services" id="services"
                                                    ...
                                                    <option MyServiceAmount="0.00" value="">اختر خدمة</option>
                                        ...
                                        <tr>
                                            <th class="text-center">
                                                <select id="tax" class="tax" name="tax" class="form-control">
                                                    <option MyTax="" value="">حدد الضريبة</option>
                                                    @foreach($tax as $t)
                                                        <option MyTax="{{ $t->per }}"
                                                                value="{{ $t->id }}"
