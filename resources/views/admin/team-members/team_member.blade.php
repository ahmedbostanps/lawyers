                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table id="user_table" class="table">
                            <thead>
                            <tr>
                                <th width="5%">@lang('panel.No')</th>
                                <th width="30%">@lang('panel.Name')</th>
                                <th width="30%">@lang('panel.Email')</th>
                                <th>@lang('panel.Contact No')</th>
                                <th>@lang('panel.Role')</th>
                                <th>@lang('panel.Status')</th>
                                <th width="5%">@lang('panel.Action')</th>
                            </tr>
                            </thead>
