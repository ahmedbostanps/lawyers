                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="f_name">الإسم الأول <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="f_name" name="f_name"
                                       value="{{ $client->first_name ?? ''}}">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="m_name">إسم الأب <span class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control" id="m_name" name="m_name"
                                       value="{{ $client->middle_name ?? ''}}">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">الإسم الأخير <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" name="gender" id="genderF"
                                       value="Female" {{ (!empty($client->gender) && $client->gender =='Female') ? "checked" : "" }}/>&nbsp;&nbsp;أنثى
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">رقم التواصل. <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">رقم إضافي.</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">المنطقة <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">المدينة <span class="text-danger">*</span></label>
