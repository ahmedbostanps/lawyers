                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="{{ request()->is('admin/clients/*') ? 'active' : '' }}"><a
                                href="{{ route('clients.show', [$client->id]) }}">تفاصيل العميل</a>
                        </li>

                        @if($adminHasPermition->can(['case_list']) =="1")
                            <li class="{{ request()->is('admin/client/case-list/*') ? 'active' : '' }}"
                                role="presentation"><a href="{{route('clients.case-list',[$client->id])}}">القضايا</a>
                            </li>
                        @endif
                ...
                <div class="x_content">
                    ...
                    <table id="clientCaselistDatatable1" class="table"
                        ...
                        <tr>
                            <th>No</th>
                            <th>تفاصيل القضية</th>
                            <th>تفاصيل المحكمة</th>
                            <th>الملتمس مقابل المدعى عليه</th>
