                    ...
                    <div class="x_content">
                        @if (count($errors) > 0)
                            <div class="alert alert-danger">
                                <strong>حدث خطأ !</strong> الرجاء التحقق من الحقول.<br><br>
                                <ul>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" name="gender" id="genderM" value="Male" checked="" required/> &nbsp;&nbsp;ذكر&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="gender" id="genderF" value="Female"/>&nbsp;&nbsp;أنثى
                            </div>
