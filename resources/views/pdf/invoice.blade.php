...
<table border="1" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr>
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td width="96%" style="font-size: 12px;">
                                    ...
                                    <br>
                                    <strong>العنوان:- </strong>{{$advocate_client->address}}
                                    {{$city}}
                                    <br>
                                    <strong>رقم الهاتف:- </strong> {{$advocate_client->mobile}}
                                    <br/>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td width="36%" valign="top">
                        <table width="100%" border="0" cellpadding="4" cellspacing="0"
                            ...
                            <tr>
                                <td width="50%"><strong>رقم الفاتورة.</strong></td>
                                <td width="50%">: {{ $invoice_no ?? ''}}</td>
                            </tr>
                            <tr>
                                <td style=""><strong>تاريخ الفاتورة:</strong></td>
                                <td style="">: {{ $inv_date ?? ''}}</td>
                            </tr>
                            <tr>
                                <td style="border-bottom:0px solid black;"><strong>تاريخ استحقاق الفاتورة:</strong></td>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                    <td width="3%" align="center"
                        ...
                        <strong>الرقم</strong></td>
                    <td width="25%" align="left"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>الخدمة</strong>
                    </td>
                    <td width="50%" align="left"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>الوصف</strong>
                    </td>

                    <td width="9%" align="center"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>الكمية</strong>
                    </td>
                    <td width="7%" align="center"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;">
                        <strong>التقييم</strong></td>
                ...
                <tr>
                    ...
                    <td align="center" style="border-right: 1px solid #000;font-size: 9pt;"><strong>المجموع</strong></td>
                ...
                <tr>
                    ...
                    <td width="28%" border="0" style="border-left:1px solid black;">
                        <table width="100%" border="0">
                            <tr>
                                <td width="75%" style="font-weight: bolder;">المجموع الفرعي</td>
                                <td width="25%" style="font-weight: bolder;" align="right">{{$subTotal}}</td>
                            </tr>

                            <tr>
                                <td width="75%" style="font-weight: bolder;">الضريبة</td>
                                <td width="25%" style="font-weight: bolder;" align="right">{{$tax_amount}}</td>
                            </tr>

                            <tr>
                                <td style="font-weight: bolder;">المجموع</td>
    ...
    <tr>
        <td>
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                    <td style="font-size: 11px;"><strong style="font-size:13px;">الشروط والأحكام :</strong> <br/>
                        <ul>
                            @if(!empty($myTerm))
                                @foreach($myTerm as $t)
                                    <li> {{ $t}}</li>
                        ...
                        <strong style="font-size:15px;">رقم GSTIN. </strong></td>
                    <td style="border-left: 1px solid #000;" valign="top" width="33%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <strong style="font-size:13px;">ملاحظات :</strong> <br/>
                                    {{$invoice->remarks}}
                                </td>
                            </tr>
                        </table>
